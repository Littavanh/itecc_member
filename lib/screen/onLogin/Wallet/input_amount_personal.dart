...
import '../../../controller/request_payment_personal.dart';
import '../../../style/color.dart';

final box = GetStorage();

class InputAmountPersonal extends StatelessWidget {
  const InputAmountPersonal({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    RequestPaymentPersonalController requestPaymentPersonal =
        Get.put(RequestPaymentPersonalController());
