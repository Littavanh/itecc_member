...
class _PinAuthScreenState extends State<PinAuthScreen> {
  ...
  @override
  CheckPinController checkPinController = Get.put(CheckPinController());
          ...
          children: [
            ...
            CustomKeyBoard(
              ...
              onCompleted: (p0) {
                ...
                checkPinController.postCheckPin(pinNumber: p0,shopCode: shopCode,amount: amount,shopName:shopName);
              },
            ),
          ],
        ),
