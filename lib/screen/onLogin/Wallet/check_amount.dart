...
class CheckAmount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var amountValue = argumentsData[2];
    var descriptionValue = argumentsData[3];

    final amountController = TextEditingController(text: amountValue);
    final descriptionController = TextEditingController(text: descriptionValue);
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            // print('pay');
                            // requestPaymentStaff.postRequestPaymentStaff(
                            //     shopCode: shopCode,
                            //     requestAmount: amountValue,
                            //     descript: descriptionValue);
