...
import 'pin_auth_screen_personal.dart';
import 'pin_auth_screen_transfer_personal .dart';

final box = GetStorage();

class InputTransferPersonalAmount extends StatelessWidget {
  const InputTransferPersonalAmount({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    var mobileNumber = argumentsData[1];
    var firstName = argumentsData[2];
    var lastName = argumentsData[3];
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            Get.to(PinAuthScreenTransferPersonal(), arguments: [
                              cusID,
